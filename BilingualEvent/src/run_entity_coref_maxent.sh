./compile.sh
java -Xmx16g -cp ../lib/edu.mit.jwi_2.2.3.jar:../lib/stanford-classifier-3.2.0.jar:. entity/coref/EntityCorefTrain 0 maxent
java -Xmx16g -cp ../lib/edu.mit.jwi_2.2.3.jar:../lib/stanford-classifier-3.2.0.jar:. entity/coref/EntityCorefTest 0 maxent
