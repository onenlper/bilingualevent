...
public class ActiveSelect {
	...
	public static double getActiveScore(EventMention event) {
		double scores = 0;
		double divide = 1;
		scores += event.subTypeConfidences.get(Util.subTypes
				.indexOf(event.subType));
...
//			divide += 1;
	...
	public static HashMap<String, HashSet<Integer>> loadSelectedEvents(
			String file) {
	...
	public static void main(String args[]) {
		...
		HashMap<String, HashSet<String>> knownTrigger = Common
				.readFile2Map6("chinese_trigger_known" + Util.part);
		HashSet<String> train_words = Common.readFile2Set("train_words"
				+ Util.part);

		HashMap<String, Integer> trainWordsCount = Common
				.readFile2Map("trainWordsCount" + Util.part);
...
//				}
		...
		ArrayList<Entry> sortedTrueEntry = new ArrayList<Entry>(
				trueTriggerEntries);
		...
		ArrayList<Entry> sortedFalseEntry = new ArrayList<Entry>(
				falseTriggerEntries);
