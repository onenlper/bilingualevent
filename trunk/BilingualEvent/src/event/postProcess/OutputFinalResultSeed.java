...
public class OutputFinalResultSeed {
	public static void main(String args[]) {
		...
		CrossValidationSeed.evaluate(model, allMentions, files, "chi");
	}
...
//		System.out.println(argumentRoleLines.size() + "#####");
//		System.out.println(argumentLines.size() + "#!!!!");
		for(int i=0;i<argumentLines.size();i++) {
			String argumentLine = argumentLines.get(i);
			String argumentRoleLine = argumentRoleLines.get(i);
			...
			String role = JointArgumentSeed.roles.get(Integer.parseInt(tokens[0])-1);
			...
			String roleResult = JointArgumentSeed.roles.get(Integer.parseInt(tokens[0])-1);
